    ...
    public class SimBody
    {
        ...
        public void Update()
        {
            ...
            for (int i = 0; i < indices.Length; i += 3)
            {
                ...
                Rasterize(new Vector2(posA.X, posA.Y), new Vector2(posB.X, posB.Y));
                Rasterize(new Vector2(posB.X, posB.Y), new Vector2(posC.X, posC.Y));
                Rasterize(new Vector2(posC.X, posC.Y), new Vector2(posA.X, posA.Y));
            }
            
        }

        public void Rasterize(in Vector2 a, in Vector2 b)
        {
